...
- Add 39 tests with more than 90% package coverage, including a deterministic
...
- Exercise the official OpenAI SDK at the HTTP boundary to verify
  `responses.parse`, generated strict JSON Schema, Pydantic parsing, and usage
  metadata without requiring a paid API call.
